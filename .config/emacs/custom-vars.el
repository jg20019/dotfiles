...
(custom-set-faces
 ...
 '(org-document-title ((t (:inherit default :weight bold :foreground "#ffffff" :font "ETBembo" :height 2.0 :underline nil))))
 '(org-indent ((t (:inherit (org-hide fixed-pitch)))))
 '(org-level-1 ((t (:inherit default :weight bold :foreground "#ffffff" :font "ETBembo" :height 1.75))))
